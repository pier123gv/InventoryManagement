package com.mycompany.inventorymanagementclient.userinterface;
...
public class ProvisionaryCommandLineInterface implements Runnable {
    private final InventoryManagementClient management;

    public ProvisionaryCommandLineInterface(InventoryManagementClient management) {
